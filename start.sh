...
if ! curl -s --max-time 2 http://127.0.0.1:11434/api/tags > /dev/null; then
    ...
    echo "   Then pull models: ollama pull gemma4:e4b && ollama pull qwen3-vl:latest && ollama pull ornith-1.5:9b && ollama pull qwen3.5:4b && ollama pull x/flux2-klein:latest"
fi
